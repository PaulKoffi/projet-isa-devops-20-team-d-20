...
Fonctionnalité: Drone Delivery
  ...
  Scénario: L'entreprise enregistre des livraisons
    ...
    Et à sa demande, il enregistre une livraison le 12/06/2020 à 10h00 pour le colis 600
    Alors l'employé explique cela n'est pas possible
    Et donc la cliente reprogramme sa livraison pour le 13/06/2020 à 10h00 pour le colis 600
  ...
  Scénario: L'entreprise enregistre des livraisons
    ...
    Alors elle change le numéro du colis en 1000
  ...
  Scénario: Livrasions
   ...
   Scénario: Gestion des factures
    ...
    Scénario: Livraison
      ...
      Alors on livre celle au colis numéro 600
      Et donc à la fin de la journée le fournisseur AUG a 1 facture de 30€ à payer